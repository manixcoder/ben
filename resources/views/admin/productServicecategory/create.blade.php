        ...
        <form method="POST" action="{{ url('/admin/services-category-management/save-services-category') }}" enctype="multipart/form-data">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" name="category_name" class="form-control @error('category_name') has-danger @enderror" value="{{ old('category_name') }}" placeholder="Comapany Sub Category">
                    @error('category_name')
