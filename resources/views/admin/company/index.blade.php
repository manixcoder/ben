                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <span class=" pull-right view-all"><a href="./details-company-info.html">View Details</a>
                                    <button type="submit" class="btn btn-primary">Decline</button>
                                    <button type="submit" class="btn btn-primary bgcolor">Accept</button>
                                </span>
                                <span class="pull-right"><img src="{{ asset('public/adminAssets/images/timer.png')}}" alt="timer" width="15px">Auto Accept In :
                                    <span class="min-timer">03:00 min</span>
                                </span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ul class="calldetail-box">
                                    ...
                                    <li><a href="#"><img src="{{ asset('public/adminAssets/images/message.png')}}" alt="icon"></a></li>
                                    <li><a href="#"><img src="{{ asset('public/adminAssets/images/call.png')}}" alt="icon"></a></li>
                                </ul>
                                <span class=" pull-right view-all"><a href="#">View Details</a>
                                </span>
                            </td>
