...
<div class="user-name">
    <div class="row">
        @php
        $categorydata = DB::table('categories')->where('c_type', 'Business')->where('parent_id', '0')->get();
        @endphp
        <form method="POST" action="{{ url('/admin/category-management/save-sub-categary') }}" enctype="multipart/form-data">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control @error('name') has-danger @enderror" placeholder="Comapany Sub Category">
                    @error('name')
